...
Use `write_file` to save plans:

```python
# Hermes-native plans (recommended)
write_file(
    path="~/.hermes/plans/YYYY-MM-DD_HHMMSS-slug.md",
    content="# Plan content..."
)

# Or relative to active workspace
write_file(
    path=".hermes/plans/YYYY-MM-DD_HHMMSS-slug.md",
    content="# Plan content..."
)
...
After saving a plan, record the invocation:
